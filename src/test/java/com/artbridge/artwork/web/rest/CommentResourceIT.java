...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().member(DEFAULT_MEMBER).content(DEFAULT_CONTENT);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().member(UPDATED_MEMBER).content(UPDATED_CONTENT);
        return comment;
    }
    ...
    void createComment() throws Exception {
        ...
        assertThat(testComment.getMember()).isEqualTo(DEFAULT_MEMBER);
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.member(UPDATED_MEMBER).content(UPDATED_CONTENT);
        ...
        Comment testComment = commentList.get(commentList.size() - 1);
        assertThat(testComment.getMember()).isEqualTo(UPDATED_MEMBER);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.member(UPDATED_MEMBER);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.member(UPDATED_MEMBER).content(UPDATED_CONTENT);
