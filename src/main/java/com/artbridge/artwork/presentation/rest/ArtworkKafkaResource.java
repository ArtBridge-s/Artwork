...
@RestController
@RequestMapping("/api/artwork-kafka")
public class ArtworkKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ArtworkKafkaResource.class);
    ...
    public ArtworkKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
